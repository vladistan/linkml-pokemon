...
linkml_meta = LinkMLMeta(
    {
        ...
        "prefixes": {
            ...
            "linkml_common": {
                "prefix_prefix": "linkml_common",
                "prefix_reference": "https://w3id.org/linkml/common/",
            },
            "linkml_pokemon": {
                "prefix_prefix": "linkml_pokemon",
...
class Thing(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Thing"], "slot_uri": "rdfs:label"}
        },
    )
    description: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Thing"], "slot_uri": "rdfs:comment"}
        },
    )
...
class Person(NamedIndividual):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "foaf:Person", "from_schema": "http://xmlns.com/foaf/0.1/"}
    )

    depiction: Optional[str] = Field(
        default=None,
...
class CmykColor(ConfiguredBaseModel):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://dbpedia.org/ontology/", "mixin": True}
    )

    cmykC: Optional[int] = Field(
        default=None,
...
class Color(CmykColor, Thing):
    ...
    wavelength: Optional[float] = Field(
        default=None,
        description="""The wavelength of the color in meters (e.g., 4.5e-07 for blue)""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Color"], "slot_uri": "dbpedia:wavelength"}
        },
    )
    frequency: Optional[float] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Color"], "slot_uri": "dbpedia:frequency"}
        },
    )
    colorHexCode: Optional[str] = Field(
        default=None,
        description="""Hexadecimal RGB color code (e.g., \"0000FF\" for blue)""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Color"], "slot_uri": "dbpedia:colourHexCode"}
        },
    )
    connotation: Optional[list[str]] = Field(
        default=None,
        description="""Cultural or symbolic meanings associated with this color""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Color"], "slot_uri": "dbpedia:connotation"}
        },
    )
    thumbnail: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Color"], "slot_uri": "dbpedia:thumbnail"}
        },
    )
    cmykC: Optional[int] = Field(
        default=None,
...
class Concept(Thing):
    ...
    abbreviation: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Concept"], "slot_uri": "qudt:abbreviation"}
        },
    )
    deprecated: Optional[bool] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Concept"], "slot_uri": "qudt:deprecated"}
        },
    )
    plainTextDescription: Optional[str] = Field(
        default=None,
...
class Quantifiable(Aspect):
    ...
    hasUnit: Optional[str] = Field(
        default=None,
        description="""Unit associated with a quantifiable entity""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Quantifiable"], "slot_uri": "qudt:hasUnit"}
        },
    )
    standardUncertainty: Optional[Decimal] = Field(
        default=None,
    ...
    relativeStandardUncertainty: Optional[float] = Field(
        default=None,
...
class Verifiable(Aspect):
    ...
    dbpediaMatch: Optional[str] = Field(
        default=None,
    ...
    wikidataMatch: Optional[str] = Field(
        default=None,
    ...
    informativeReference: Optional[list[str]] = Field(
        default=None,
    ...
    isoNormativeReference: Optional[list[str]] = Field(
        default=None,
    ...
    normativeReference: Optional[list[str]] = Field(
        default=None,
...
class Quantity(Quantifiable, Concept):
    ...
    hasQuantityKind: Optional[list[str]] = Field(
        default=None,
    ...
    quantityValue: Optional[list[str]] = Field(
        default=None,
        description="""The value component of a quantity""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Quantity"], "slot_uri": "qudt:quantityValue"}
        },
    )
    hasUnit: Optional[str] = Field(
        default=None,
...
class QuantityValue(Concept):
    ...
    numericValue: Optional[float] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["QuantityValue"], "slot_uri": "qudt:value"}
        },
    )
    unit: Optional[str] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["QuantityValue"], "slot_uri": "qudt:unit"}
        },
    )
    abbreviation: Optional[str] = Field(
        default=None,
...
class AbstractQuantityKind(Concept):
    ...
    broader: Optional[list[str]] = Field(
        default=None,
...
class QuantityKind(AbstractQuantityKind, Verifiable):
    ...
    latexSymbol: Optional[str] = Field(
        default=None,
    ...
    hasDimensionVector: Optional[str] = Field(
        default=None,
    ...
    applicableUnit: Optional[list[str]] = Field(
        default=None,
...
class Unit(Verifiable, Concept):
    ...
    conversionMultiplier: Optional[float] = Field(
        default=None,
    ...
    conversionOffset: Optional[float] = Field(
        default=None,
        description="""Offset to convert to base unit""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Unit"], "slot_uri": "qudt:conversionOffset"}
        },
    )
    hasDimensionVector: Optional[str] = Field(
        default=None,
    ...
    isUnitOfSystem: Optional[list[str]] = Field(
        default=None,
        description="""System of units this unit belongs to""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Unit"], "slot_uri": "qudt:isUnitOfSystem"}
        },
    )
    applicableSystem: Optional[list[str]] = Field(
        default=None,
        description="""Systems where this unit is applicable""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Unit"], "slot_uri": "qudt:applicableSystem"}
        },
    )
    ...
    scalingOf: Optional[str] = Field(
        default=None,
        description="""Base unit this unit is a scaling of""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Unit"], "slot_uri": "qudt:scalingOf"}
        },
    )
...
class SystemOfUnits(Concept):
    ...
    hasBaseUnit: Optional[list[str]] = Field(
        default=None,
...
class QuantityKindDimensionVector(Concept):
    ...
    dimensionExponentForLength: Optional[int] = Field(
        default=None,
    ...
    dimensionExponentForMass: Optional[int] = Field(
        default=None,
    ...
    dimensionExponentForTime: Optional[int] = Field(
        default=None,
    ...
    dimensionExponentForElectricCurrent: Optional[int] = Field(
        default=None,
    ...
    dimensionExponentForThermodynamicTemperature: Optional[int] = Field(
        default=None,
    ...
    dimensionExponentForAmountOfSubstance: Optional[int] = Field(
        default=None,
    ...
    dimensionExponentForLuminousIntensity: Optional[int] = Field(
        default=None,
    ...
    dimensionlessExponent: Optional[int] = Field(
        default=None,
...
class Prefix(Verifiable, Concept):
    ...
    prefixMultiplier: Optional[float] = Field(
        default=None,
...
class Ability(Thing):
    ...
    effectDescription: Optional[list[str]] = Field(
        default=None,
...
class Generation(Thing):
    ...
    featuresSpecies: Optional[list[str]] = Field(
        default=None,
...
class Food(Item):
    ...
    hasFlavor: Optional[list[str]] = Field(
        default=None,
    ...
    firmness: Optional[int] = Field(
        default=None,
        description="""How firm a berry or food item feels, affecting its use in Pokéblock or Poffin making.""",
        json_schema_extra={"linkml_meta": {"domain": "Food", "domain_of": ["Food"]}},
    )
    smoothness: Optional[int] = Field(
        default=None,
        description="""How smooth a berry or food item is, affecting its use in Pokéblock or Poffin making.""",
        json_schema_extra={"linkml_meta": {"domain": "Food", "domain_of": ["Food"]}},
    )
    id: str = Field(
        default=...,
...
class Berry(Food):
    ...
    hasSize: Optional[Quantity] = Field(
        default=None,
        description="""The physical size of an entity, expressed as a quantity with unit.""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Berry"], "slot_uri": "pokemon:hasSize"}
        },
    )
    hasFlavor: Optional[list[str]] = Field(
        default=None,
...
class PokedexEntry(Thing):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "class_uri": "https://pokemonkg.org/ontology#Pok%C3%A9dexEntry",
            "from_schema": "https://pokemonkg.org/ontology",
        }
    )
...
class Place(Thing):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"abstract": True, "from_schema": "https://pokemonkg.org/ontology"}
    )
...
class Species(NamedIndividual):
    ...
    hasColor: Optional[str] = Field(
        default=None,
        description="""A Pokémon has a color""",
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Species"], "slot_uri": "pokemon:hasColour"}
        },
    )
    mayHaveHiddenAbility: Optional[list[Literal["mayHaveAbility"]]] = Field(
        default=None,
        description="""A special ability only obtainable through specific encounters or events, not through normal gameplay.""",
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
                "domain_of": ["Species"],
    ...
    mayHaveAbility: Optional[list[str]] = Field(
        default=None,
    ...
    isAbleToApply: Optional[list[str]] = Field(
        default=None,
    ...
    hasHeight: Optional[Quantity] = Field(
        default=None,
        description="""How tall a Pokémon species is, expressed as a quantity with unit.""",
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
                "domain_of": ["Species"],
    ...
    hasWeight: Optional[Quantity] = Field(
        default=None,
        description="""How heavy a Pokémon species is, expressed as a quantity with unit.""",
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
                "domain_of": ["Species"],
    ...
    inEggGroup: Optional[list[str]] = Field(
        default=None,
        description="""Which egg group a species belongs to, controlling which Pokémon can breed together.""",
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
                "domain_of": ["Species"],
    ...
    hasType: Optional[list[Type]] = Field(
        default=None,
    ...
    hasShape: Optional[str] = Field(
        default=None,
        description="""The shape of a berry is a measure of how good it is for making a Potion.""",
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
                "domain_of": ["Species"],
    ...
    hasGenus: Optional[str] = Field(
        default=None,
        description="""The species category label shown in the Pokédex, such as \"Seed Pokémon\" for Bulbasaur.""",
        json_schema_extra={
            "linkml_meta": {"domain": "Species", "domain_of": ["Species"]}
        },
    )
    hasCatchRate: Optional[int] = Field(
        default=None,
        description="""Determines how easy a Pokémon species is to catch, with higher values meaning easier capture.""",
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
                "domain_of": ["Species"],
    ...
    foundIn: Optional[list[str]] = Field(
        default=None,
...
class Move(Thing):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "pokemon:Move", "from_schema": "https://pokemonkg.org/ontology"}
    )
...
class TM(MoveLearning, Item):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"from_schema": "https://pokemonkg.org/ontology", "mixins": ["MoveLearning"]}
    )
...
class Type(NamedIndividual):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "pokemon:Type", "from_schema": "https://pokemonkg.org/ontology"}
    )
