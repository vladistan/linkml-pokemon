...
class Quantity(Quantifiable, Concept):
    ...
    hasQuantityKind: Optional[list[str]] = Field(default=None, description="""Associates a quantity with its kind (e.g., Height, Weight)""", json_schema_extra = { "linkml_meta": {'alias': 'hasQuantityKind',
    ...
    quantityValue: Optional[list[str]] = Field(default=None, description="""The value component of a quantity""", json_schema_extra = { "linkml_meta": {'alias': 'quantityValue',
...
class QuantityValue(Concept):
    ...
    numericValue: Optional[float] = Field(default=None, description="""Numeric value of a quantity""", json_schema_extra = { "linkml_meta": {'alias': 'numericValue',
         ...
         'range': 'double',
         'slot_uri': 'qudt:value'} })
    unit: Optional[str] = Field(default=None, description="""Unit of measurement""", json_schema_extra = { "linkml_meta": {'alias': 'unit',
...
class Species(NamedIndividual):
    ...
    hasColor: Optional[str] = Field(default=None, description="""A Pokémon has a color""", json_schema_extra = { "linkml_meta": {'alias': 'hasColor',
         ...
         'required': False,
         'slot_uri': 'pokemon:hasColour'} })
    mayHaveHiddenAbility: Optional[list[str]] = Field(default=None, description="""A special ability only obtainable through specific encounters or events, not through normal gameplay.""", json_schema_extra = { "linkml_meta": {'alias': 'mayHaveHiddenAbility',
         ...
         'slot_uri': 'pokemon:mayHaveHiddenAbility',
         'subproperty_of': 'mayHaveAbility'} })
    mayHaveAbility: Optional[list[str]] = Field(default=None, description="""A Pokémon may have an ability""", json_schema_extra = { "linkml_meta": {'alias': 'mayHaveAbility',
         ...
         'range': 'Ability',
         'slot_uri': 'pokemon:mayHaveAbility'} })
    isAbleToApply: Optional[list[str]] = Field(default=None, description="""Moves that a Pokémon can use in battle or in the overworld.""", json_schema_extra = { "linkml_meta": {'alias': 'isAbleToApply',
    ...
    depiction: Optional[str] = Field(default=None, description="""A depiction of the person""", json_schema_extra = { "linkml_meta": {'alias': 'depiction',
         ...
         'range': 'string',
         'slot_uri': 'foaf:depiction'} })
    inEggGroup: Optional[list[str]] = Field(default=None, description="""Which egg group a species belongs to, controlling which Pokémon can breed together.""", json_schema_extra = { "linkml_meta": {'alias': 'inEggGroup',
