...
The core schema is defined in [`linkml_pokemon.yaml`](https://github.com/vladistan/linkml-pokemon/blob/main/src/linkml_pokemon/schema/linkml_pokemon.yaml). The table below summarizes its components, including how many are specific to the Pokemon domain versus imported from external schemas.

| | Total | Pokemon Domain | Imported |
| --- | ---: | ---: | ---: |
| [**Classes**](datadict.md#classes) | 58 | 34 | 24 |
| [**Slots**](datadict.md#slots) | 83 | 32 | 51 |
| [**Enums**](datadict.md#enums) | 1 | 1 | 0 |
...
And here is a high-level ERD diagram of the schema structure, key classes, and relationships. Note this is a simplified extraction from the larger schema. For a complete reference, see the [Data Dictionary](datadict.md).

![Simplified ERD Diagram](images/simplified_erd_diagram.svg)
...
| Class | Description |
| --- | --- |
| [**Species**](datadict.md#species) | A Pokemon species with stats, types, abilities, height, weight, color, habitat |
| [**Move**](datadict.md#move) | Battle moves with base power, accuracy, PP, type, and effect descriptions |
| [**Type**](datadict.md#type) | The 18 Pokemon types (Fire, Water, Grass, etc.) with strengths and weaknesses |
| [**Ability**](datadict.md#ability) | Special abilities that each Pokemon can have, including hidden abilities |
| [**Item**](datadict.md#item) | Objects the player can use - Poke Balls, medicines, hold items, berries, TMs/HMs |
...
The knowledge graph data originates from the [Pokemon Knowledge Graph](https://pokemonkg.org/) project. A copy of the original dataset is included in the [`original/`](https://github.com/vladistan/linkml-pokemon/tree/main/original) directory:
...
The original data contains several errors that have been identified and patched. See [Data Patches](DATA_PATCHES.md) for full details.
...
The following artifacts are generated from the schema and available in the [`project/`](https://github.com/vladistan/linkml-pokemon/tree/main/project) directory:

| Artifact | File | Description |
| --- | --- | --- |
| GraphQL | [`linkml_pokemon.graphql`](https://github.com/vladistan/linkml-pokemon/blob/main/project/graphql/linkml_pokemon.graphql) | GraphQL schema definition |
| OWL | [`linkml_pokemon.owl.ttl`](https://github.com/vladistan/linkml-pokemon/blob/main/project/owl/linkml_pokemon.owl.ttl) | OWL ontology in Turtle format |
| Pydantic | [`linkml_pokemon.py`](https://github.com/vladistan/linkml-pokemon/blob/main/project/pydantic/linkml_pokemon.py) | Python Pydantic v2 models |
| TypeScript | [`linkml_pokemon.ts`](https://github.com/vladistan/linkml-pokemon/blob/main/project/typescript/linkml_pokemon.ts) | TypeScript type definitions |
| JSON Schema | [`linkml_pokemon.schema.json`](https://github.com/vladistan/linkml-pokemon/blob/main/project/jsonschema/linkml_pokemon.schema.json) | JSON Schema for data validation |
| JSON-LD | [`linkml_pokemon.context.jsonld`](https://github.com/vladistan/linkml-pokemon/blob/main/project/jsonld/linkml_pokemon.context.jsonld) | JSON-LD context for linked data |
| SHACL | [`linkml_pokemon.shacl.ttl`](https://github.com/vladistan/linkml-pokemon/blob/main/project/shacl/linkml_pokemon.shacl.ttl) | SHACL shapes for RDF validation |
| SQL | [`linkml_pokemon.sql`](https://github.com/vladistan/linkml-pokemon/blob/main/project/sqlschema/linkml_pokemon.sql) | SQL DDL for relational databases |
