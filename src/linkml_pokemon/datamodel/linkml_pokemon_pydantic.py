...
class CmykColor(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://dbpedia.org/ontology/', 'mixin': True})

    cmykC: Optional[int] = Field(default=None, description="""Cyan component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateCyanic'} })
    cmykM: Optional[int] = Field(default=None, description="""Magenta component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateMagenta'} })
    cmykY: Optional[int] = Field(default=None, description="""Yellow component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateYellow'} })
    cmykK: Optional[int] = Field(default=None, description="""Black (K) component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateBlack'} })
...
class Color(CmykColor, Thing):
    ...
    wavelength: Optional[float] = Field(default=None, description="""The wavelength of the color in meters (e.g., 4.5e-07 for blue)""", json_schema_extra = { "linkml_meta": {'domain_of': ['Color'], 'slot_uri': 'dbpedia:wavelength'} })
    frequency: Optional[float] = Field(default=None, description="""The frequency of the color in Hz""", json_schema_extra = { "linkml_meta": {'domain_of': ['Color'], 'slot_uri': 'dbpedia:frequency'} })
    colorHexCode: Optional[str] = Field(default=None, description="""Hexadecimal RGB color code (e.g., \"0000FF\" for blue)""", json_schema_extra = { "linkml_meta": {'domain_of': ['Color'], 'slot_uri': 'dbpedia:colourHexCode'} })
    connotation: Optional[list[str]] = Field(default=None, description="""Cultural or symbolic meanings associated with this color""", json_schema_extra = { "linkml_meta": {'domain_of': ['Color'], 'slot_uri': 'dbpedia:connotation'} })
    thumbnail: Optional[str] = Field(default=None, description="""URL to a representative image of this color""", json_schema_extra = { "linkml_meta": {'domain_of': ['Color'], 'slot_uri': 'dbpedia:thumbnail'} })
    cmykC: Optional[int] = Field(default=None, description="""Cyan component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateCyanic'} })
    cmykM: Optional[int] = Field(default=None, description="""Magenta component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateMagenta'} })
    cmykY: Optional[int] = Field(default=None, description="""Yellow component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateYellow'} })
    cmykK: Optional[int] = Field(default=None, description="""Black (K) component in CMYK color model (0-100)""", json_schema_extra = { "linkml_meta": {'domain_of': ['CmykColor'], 'slot_uri': 'dbpedia:cmykCoordinateBlack'} })
...
class Generation(Thing):
    ...
    featuresSpecies: Optional[list[str]] = Field(default=None, description="""['A Pokédex entry features a species']""", json_schema_extra = { "linkml_meta": {'domain_of': ['Generation'], 'slot_uri': 'pokemon:featuresSpecies'} })
    id: str = Field(default=..., description="""A unique identifier""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'linkml_common:identifier'} })
    name: Optional[str] = Field(default=None, description="""Human-readable label for the entity""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'rdfs:label'} })
    description: Optional[str] = Field(default=None, description="""A description of the entity""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'rdfs:comment'} })
...
class Food(Item):
    ...
    hasFlavor: Optional[list[str]] = Field(default=None, description="""A Pokémon has a flavor""", json_schema_extra = { "linkml_meta": {'domain': 'Food', 'domain_of': ['Food'], 'slot_uri': 'pokemon:hasFlavor'} })
    firmness: Optional[int] = Field(default=None, description="""How firm a berry or food item feels, affecting its use in Pokéblock or Poffin making.""", json_schema_extra = { "linkml_meta": {'domain': 'Food', 'domain_of': ['Food']} })
    smoothness: Optional[int] = Field(default=None, description="""How smooth a berry or food item is, affecting its use in Pokéblock or Poffin making.""", json_schema_extra = { "linkml_meta": {'domain': 'Food', 'domain_of': ['Food']} })
    id: str = Field(default=..., description="""A unique identifier""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'linkml_common:identifier'} })
    name: Optional[str] = Field(default=None, description="""Human-readable label for the entity""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'rdfs:label'} })
    description: Optional[str] = Field(default=None, description="""A description of the entity""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'rdfs:comment'} })
...
class Berry(Food):
    ...
    hasSize: Optional[Quantity] = Field(default=None, description="""The physical size of an entity, expressed as a quantity with unit.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Berry'], 'slot_uri': 'pokemon:hasSize'} })
    hasFlavor: Optional[list[str]] = Field(default=None, description="""A Pokémon has a flavor""", json_schema_extra = { "linkml_meta": {'domain': 'Food', 'domain_of': ['Food'], 'slot_uri': 'pokemon:hasFlavor'} })
    firmness: Optional[int] = Field(default=None, description="""How firm a berry or food item feels, affecting its use in Pokéblock or Poffin making.""", json_schema_extra = { "linkml_meta": {'domain': 'Food', 'domain_of': ['Food']} })
    smoothness: Optional[int] = Field(default=None, description="""How smooth a berry or food item is, affecting its use in Pokéblock or Poffin making.""", json_schema_extra = { "linkml_meta": {'domain': 'Food', 'domain_of': ['Food']} })
    id: str = Field(default=..., description="""A unique identifier""", json_schema_extra = { "linkml_meta": {'domain_of': ['Thing'], 'slot_uri': 'linkml_common:identifier'} })
...
class Place(Thing):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True, 'from_schema': 'https://pokemonkg.org/ontology'})
...
class Species(NamedIndividual):
    ...
    hasColor: Optional[str] = Field(default=None, description="""A Pokémon has a color""", json_schema_extra = { "linkml_meta": {'domain_of': ['Species'], 'slot_uri': 'pokemon:hasColour'} })
    mayHaveHiddenAbility: Optional[list[Literal["mayHaveAbility"]]] = Field(default=None, description="""A special ability only obtainable through specific encounters or events, not through normal gameplay.""", json_schema_extra = { "linkml_meta": {'domain': 'Species',
         'domain_of': ['Species'],
         'slot_uri': 'pokemon:mayHaveHiddenAbility',
         'subproperty_of': 'mayHaveAbility'} })
    mayHaveAbility: Optional[list[str]] = Field(default=None, description="""A Pokémon may have an ability""", json_schema_extra = { "linkml_meta": {'domain': 'Species',
         'domain_of': ['Species'],
         'slot_uri': 'pokemon:mayHaveAbility'} })
    isAbleToApply: Optional[list[str]] = Field(default=None, description="""Moves that a Pokémon can use in battle or in the overworld.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Species'], 'slot_uri': 'pokemon:isAbleToApply'} })
    hasHeight: Optional[Quantity] = Field(default=None, description="""How tall a Pokémon species is, expressed as a quantity with unit.""", json_schema_extra = { "linkml_meta": {'domain': 'Species', 'domain_of': ['Species'], 'slot_uri': 'pokemon:hasHeight'} })
    hasWeight: Optional[Quantity] = Field(default=None, description="""How heavy a Pokémon species is, expressed as a quantity with unit.""", json_schema_extra = { "linkml_meta": {'domain': 'Species', 'domain_of': ['Species'], 'slot_uri': 'pokemon:hasWeight'} })
    depiction: Optional[str] = Field(default=None, description="""A depiction of the person""", json_schema_extra = { "linkml_meta": {'domain_of': ['Person', 'Species'], 'slot_uri': 'foaf:depiction'} })
    inEggGroup: Optional[list[str]] = Field(default=None, description="""Which egg group a species belongs to, controlling which Pokémon can breed together.""", json_schema_extra = { "linkml_meta": {'domain': 'Species',
         'domain_of': ['Species'],
         'slot_uri': 'pokemon:inEggGroup'} })
    hasType: Optional[list[Type]] = Field(default=None, description="""A Pokémon has a type""", json_schema_extra = { "linkml_meta": {'domain_of': ['Species', 'Move'], 'slot_uri': 'pokemon:hasType'} })
    ...
    hasGenus: Optional[str] = Field(default=None, description="""The species category label shown in the Pokédex, such as \"Seed Pokémon\" for Bulbasaur.""", json_schema_extra = { "linkml_meta": {'domain': 'Species', 'domain_of': ['Species']} })
    hasCatchRate: Optional[int] = Field(default=None, description="""Determines how easy a Pokémon species is to catch, with higher values meaning easier capture.""", json_schema_extra = { "linkml_meta": {'domain': 'Species',
         'domain_of': ['Species'],
...
class TM(MoveLearning, Item):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://pokemonkg.org/ontology', 'mixins': ['MoveLearning']})
...
class Type(NamedIndividual):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'pokemon:Type', 'from_schema': 'https://pokemonkg.org/ontology'})
