...
class Colour(Thing):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {"class_uri": "dbpedia:Colour", "from_schema": "https://dbpedia.org/ontology/"}
    )

    black: Optional[float] = Field(
        default=None,
    ...
    wavelength: Optional[float] = Field(
        ...
        json_schema_extra={
            "linkml_meta": {"domain_of": ["Colour"], "slot_uri": "dbpedia:wavelength"}
        },
    )
    id: str = Field(
        default=...,
...
class Quantity(Thing):
    ...
    hasQuantityKind: Optional[str] = Field(
        default=None,
        description="""The kind of quantity (e.g., Length, Mass, Time).""",
        json_schema_extra={
            "linkml_meta": {
                "domain_of": ["Quantity"],
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            ...
            "annotations": {
                "rdfs:comment": {
                    "tag": "rdfs:comment",
                    "value": "Entities that have a somewhat fixed, physical extension.",
                }
            },
            "from_schema": "https://pokemonkg.org/ontology",
        }
...
class Species(NamedIndividual):
    ...
    mayHaveHiddenAbility: Optional[list[str]] = Field(
        default=[],
        json_schema_extra={
            "linkml_meta": {
                "domain": "Species",
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta(
        {
            "annotations": {
                "rdfs:comment": {
                    "tag": "rdfs:comment",
                    "value": "A move is a special ability of a Pokemon.",
                }
            },
