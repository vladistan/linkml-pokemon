# Contributing to linkml-pokemon

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
linkml-pokemon. These guidelines are not strict rules.
...
The linkml-pokemon team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the linkml-pokemon technical leads
...
[issues]: https://github.com/vladistan/linkml-pokemon/issues/
[pulls]: https://github.com/vladistan/linkml-pokemon/pulls/
